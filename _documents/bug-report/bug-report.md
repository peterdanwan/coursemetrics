- [Bug Report: CourseMetrics Logo Route Back to Homepage](#bug-report-coursemetrics-logo-route-back-to-homepage)
...
- [Bug Report: Footer Links Goes from Light to Dark Mode](#bug-report-footer-links-goes-from-light-to-dark-mode)
...
- [Bug Report: Weird Backend Increment of User ID in Database](#bug-report-weird-backend-increment-of-user-id-in-database)
...
- [Bug Report: Problem Signing In with Facebook that have no Email](#bug-report-problem-signing-in-with-facebook-that-have-no-email)
...
# Bug Report: CourseMetrics Logo Route Back to Homepage
...
# Bug Report: Footer Links Goes from Light to Dark Mode
...
# Bug Report: Weird Backend Increment of User ID in Database
...
# Bug Report: Problem Signing In with Facebook that have no Email
